...
function IntroScreen({ onOpen }) {
  ...
  return (
    ...
    >
      <div className="intro-label font-caveat text-[#999999] text-2xl mb-4">untuk Syafa</div>

      <div className="envelope-scene relative" style={{ perspective: '1400px', width: 'min(78vw,300px)', height: 'min(52vw,200px)' }}>
        <div className="envelope-body absolute inset-0 rounded-md border border-[#666666]/35 overflow-hidden shadow-2xl"
          ...
          <div className="letter-peek absolute left-[8%] right-[8%] flex items-start justify-center pt-3 rounded-sm"
               style={{ bottom: '-5%', height: '30%', background: '#e8e8e8' }}>
            <span className="font-caveat text-[#1a1a1a] text-lg">Buka aku ya...</span>
          </div>
        </div>
        ...
        <div className="envelope-flap absolute top-0 left-0 w-full z-10"
             style={{
               height: '56%',
               background: 'linear-gradient(160deg,#666666,#1a1a1a)',
          ...
          >
            <FaHeart size={20} className="text-[#e8e8e8]" />
          </button>
        </div>
      </div>

      <div className="intro-hint mt-6 text-xs tracking-[0.28em] uppercase text-[#888888]">ketuk segel untuk membuka</div>
    </div>
  );
}
